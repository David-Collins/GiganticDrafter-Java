...
public class Message implements Serializable {
	...
	Message(int type, String hero, int team, ArrayList<String> bans, ArrayList<String> team1Picks, ArrayList<String> team2Picks, 
			String team1Seat, String team2Seat, int turn) {
		this.type = type;
